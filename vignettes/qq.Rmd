...
plot(dx)
polygon(dx, col = rgb(0,0,0,0.3))
polygon(dy, col = rgb(1,0,0,0.3))
par(OP)
...
plot(dx, xlim = range(dx$x,dy$x), ylim = range(dx$y, dy$y), main=NULL)
polygon(dx, col = rgb(0,0,0,0.3))
polygon(dy, col = rgb(1,0,0,0.3))
par(OP)
```
...
plot(dx2, xlim = range(dx2$x,dy2$x), ylim = range(dx2$y, dy2$y), main=NULL)
polygon(dx2, col = rgb(0,0,0,0.3))
polygon(dy2, col = rgb(1,0,0,0.3))
par(OP)
```
...
```{r}
dqn <- density(s1); dmn <- density(s2)
plot(dqn, xlim = range(dqn$x,dmn$x), ylim = range(dqn$y, dmn$y), main=NULL)
polygon(dqn, col = rgb(0,0,0,0.3))
polygon(dmn, col = rgb(1,0,0,0.3))
```
