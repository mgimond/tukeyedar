...
Likewise you can omit all axes labels by setting `margin.labels` to `FALSE`. This may prove useful when applying a median polish to a large grid file.

```{r eval = FALSE}
plot(M1, res.txt = FALSE, margin.labels = FALSE)
```

```{r fig.width=3, fig.height=3, echo=FALSE}
plot(M1, res.txt = FALSE, margin.labels = FALSE,  row.size = 0.8, col.size = 0.8 , res.size = 0.8)
```
