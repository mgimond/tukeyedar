...
```{r, fig.height=2.3, fig.width = 3.2, echo=FALSE, dev.args=list(pointsize=11)}
...
```{r, fig.height=2.3, fig.width=5.5,echo=FALSE, dev.args=list(pointsize=11)}
...
```{r, fig.height=2.6, fig.width = 3.2, echo=FALSE, dev.args=list(pointsize=11)}
...
```{r fig.height=2.6, fig.width = 3.2, dev.args=list(pointsize=11)}
plot(M)
```
...
```{r, fig.height=2.6, fig.width = 3.2, echo=2, dev.args=list(pointsize=11)}
plot(M)
...
```{r fig.height=2.6, fig.width = 3.2, echo=3, dev.args=list(pointsize=11)}
plot(M) 
abline(lm(Mortality~Temp, neoplasms),lty = 2)  
...
```{r fig.height=2.6, fig.width = 3.2,  results='hide', dev.args=list(pointsize=11)}
...
```{r fig.height=2.6, fig.width = 3.2,r, dev.args=list(pointsize=11)}
