...
```{r, fig.height=2.3, fig.width = 3.2, echo=FALSE}
...
```{r fig.height=2.3, fig.width = 3.2, echo=2:3}
OP <- par(mar=c(4,4,1,1))
plot(Mortality~Temp, neoplasms, pch=20)
abline(a=M$a, b=M$b, col=rgb(1,0,0,0.5))
par(OP)
...
```{r fig.height=2.3, fig.width = 3.2, echo=2:4}
OP <- par(mar=c(4,4,1,1))
plot(Mortality~Temp, neoplasms, pch=20)
abline(a=M$a, b=M$b, col=rgb(1,0,0,0.5))
...
```{r fig.height=2.3, fig.width = 3.2, echo=2:5}
OP <- par(mar=c(4,4,1,1))
plot(Mortality~Temp, neoplasms, pch=20)
abline(a=M$a, b=M$b, col=rgb(1,0,0,0.5))
abline(lm(Mortality~Temp, neoplasms),lty=2) # Regression model
...
```{r fig.height=2.3, fig.width = 3.2, echo=2, results='hide'}
OP <- par(mar=c(4,4,1,1))
